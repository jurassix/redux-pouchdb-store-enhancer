...
function pouchdbStoreEnhancer() {
  ...
  var filterFunction = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _ignorePouchActionsFilter2.default;
  ...
  return function (createStore) {
    return function (reducer, preloadedState) {
      ...
      var pouchActionEnhancer = (0, _redux.applyMiddleware)((0, _reduxActionEnhancerMiddleware2.default)({
